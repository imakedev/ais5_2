...
<div class="ibox">
    <div class="ibox-title">
        <h5 ><span onclick="goTo('/ais/tagList')" style="cursor: pointer;padding-right:20px"></span>Tag [ {{$tagModel->B}} ]</h5>
    ...
    <div class="ibox-content">
        ...
        @endif
        <!--
        {-- !! Form::open(array('url'=> 'ais/tag/17/points')) !! --}
                -->
            <form action="/ais/tag/{{$tagModel->A}}/points" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="tag_id" id="tag_id" value="{{$tagModel->A}}"/>
        <div class="row bgParam">
            ...
            <div class="col-md-3" style="margin-top: 8px;">
                ...
                <select id="sortBy" name="sortBy">
                    <option value=""></option>
                    <option value="A">Point Index</option>
                    <option value="B">Point Desc</option>
                    <option value="D">Tag Atom</option>
                    <option value="H">Tag Index</option>
                </select>
        ...
        <form action="/pointConfiguration/deleteSelect" method="get" id="formDelete">
                    ...
                    @foreach($points_config as $index => $poi_config)
                        <tr>
                            ...
                            @foreach($columns as $index2 => $column)
                                ...
                                <td class="settext">{{$poi_config->$unit_show}}</td>
                            @endforeach
            ...
            <div>
                <a class="btn btn-primary btn-sm" onclick="goTo('/ais/tagList')">
