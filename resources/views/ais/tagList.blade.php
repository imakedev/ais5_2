...
<div class="ibox">
    ...
    <div class="ibox-content">
        ...
        @endif
        {!! Form::open(array('url'=> 'ais/tagList')) !!}
        <div class="row bgParam">
            <!--
            <div class="col-md-3">

                {{--
                <a class="btn btn-primary btn-sm" data-toggle="modal" onclick="addBtn('{{Session::get("user_mmplant")}}')">Add Point</a>
                <button class="btn btn-w-m btn-danger btn-sm" type="button" onclick="deleteBtn()">Delete select</button>
                --}}

            </div>
            -->
            <div class="col-md-7"  style="width:250px">
...
--}}
                           ...
                           <td class="center">
                               ...
                               <a href="/ais/tag/{{$tag_config->A}}/points" class="btn btn-dropbox btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
                               <!--
                                {{--
