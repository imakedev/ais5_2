...
//$(document).ready(function(){
	...
	*/
	 ...
	 $(document).on("click",".btnScaleTime",function(event){
		...
		$("#paramPointEmbed-"+paramTrendID).val($("#paramPointAllEmbed-"+paramTrendID).val());
	...
	//showPoint/hiddenPoint end
	 ...
	 function startUpFn(paramInitail,paramTrendID,paramScaleTime,paramHour,paramMinute,paramFromDate,paramToDate){
			...
			var pointId =getDataFromPointEmbed("pointId","All");
			var pointDataId= getDataFromPointEmbed("pointDataId","All");
			var unitIdPointId= getDataFromPointEmbed("unitIdPointId","All");
